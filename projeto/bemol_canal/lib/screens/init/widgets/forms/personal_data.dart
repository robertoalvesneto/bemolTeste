...
class PersonalDataForm extends StatefulWidget {
  ...
  const PersonalDataForm({Key? key, required this.onComeBackButtonPressed})
      : super(key: key);

  @override
  _PersonalDataFormState createState() {
    return _PersonalDataFormState(onComeBackButtonPressed);
  }
}
...
class _PersonalDataFormState extends State<PersonalDataForm> {
  ...
  _PersonalDataFormState(this.onComeBackButtonPressed);
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            TopContainer(
                titleName: "Dados Pessoais", callback: onComeBackButtonPressed),
            Container(
            ...
            BottomContainer(
              ...
              callback: onComeBackButtonPressed,
            ),
          ],
        ),
      ),
